...
public class WorldMapIcon_0 extends AbstractWorldMapIcon {
	...
	static final void method206(PacketBuffer var0) {
		...
		for (var3 = 0; var3 < Players.Players_count; ++var3) {
			var4 = Players.Players_indices[var3];
			if ((Players.field1236[var4] & 1) == 0) {
				if (var1 > 0) {
					--var1;
					var2 = Players.field1236;
					...
					if (var5 == 0) {
						...
						class208.readPlayerUpdate(var0, var4);
					}
				}
			}
		}
		...
		if (var1 != 0) {
			...
			if (var1 != 0) {
				...
				for (var3 = 0; var3 < Players.Players_emptyIdxCount; ++var3) {
					var4 = Players.Players_emptyIndices[var3];
					if ((Players.field1236[var4] & 1) != 0) {
						if (var1 > 0) {
							--var1;
							var2 = Players.field1236;
							...
							if (var5 == 0) {
								...
								var2 = Players.field1236;
								var2[var4] = (byte)(var2[var4] | 2);
							} else if (class40.updateExternalPlayer(var0, var4)) {
								var2 = Players.field1236;
								var2[var4] = (byte)(var2[var4] | 2);
							}
						}
