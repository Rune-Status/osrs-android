...
public class class238 {
	...
	public class238() {
		...
		for (byte var4 = 12; var1 < 16; var2 -= var4) {
			var3 = Decimator.method2600((double)((float)var2 / 360.0F), 0.9998999834060669D, (double)(0.075F + (float)var1 * 0.425F / 16.0F));
			class218.field2718[var1] = var3;
			++var1;
		}
		...
		for (int var6 = var2 / 6; var1 < class218.field2718.length; var2 -= var6) {
			...
			for (int var5 = Decimator.method2600((double)((float)var2 / 360.0F), 0.9998999834060669D, 0.5D); var1 < var3 && var1 < class218.field2718.length; ++var1) {
