...
public class MusicPatchPcmStream extends PcmStream {
	...
	protected void fill(int[] var1, int var2, int var3) {
		...
		for (MusicPatchNode var4 = (MusicPatchNode)this.queue.last(); var4 != null; var4 = (MusicPatchNode)this.queue.previous()) {
			if (!this.superStream.method3822(var4)) {
				int var5 = var2;
				int var6 = var3;

				do {
					if (var6 <= var4.field2464) {
						this.method3968(var4, var1, var5, var6, var6 + var5);
						var4.field2464 -= var6;
						break;
					}

					this.method3968(var4, var1, var5, var4.field2464, var5 + var6);
					var5 += var4.field2464;
					var6 -= var4.field2464;
				} while(!this.superStream.method3848(var4, var1, var5, var6));
			}
		}
	...
	protected void skip(int var1) {
		...
		for (MusicPatchNode var2 = (MusicPatchNode)this.queue.last(); var2 != null; var2 = (MusicPatchNode)this.queue.previous()) {
			if (!this.superStream.method3822(var2)) {
				int var3 = var1;

				do {
					if (var3 <= var2.field2464) {
						this.method3972(var2, var3);
						var2.field2464 -= var3;
						break;
					}

					this.method3972(var2, var2.field2464);
					var3 -= var2.field2464;
				} while(!this.superStream.method3848(var2, (int[])null, 0, var3));
			}
		}
