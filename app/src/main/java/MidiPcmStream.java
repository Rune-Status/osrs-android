...
public class MidiPcmStream extends PcmStream {
	...
	void method3774(int var1, int var2, int var3) {
		...
		MusicPatch var8 = (MusicPatch)this.musicPatches.get((long)this.field2443[var1]);
		if (var8 != null) {
			...
			if (var9 != null) {
				...
				var6.patch = var8;
				var6.rawSound = var9;
				var6.field2445 = var8.field2487[var2];
				var6.field2449 = var8.field2485[var2];
				var6.field2450 = var2;
				var6.field2451 = var3 * var3 * var8.field2486[var2] * var8.field2488 + 1024 >> 11;
				var6.field2457 = var8.field2482[var2] & 255;
				var6.field2446 = (var2 << 8) - (var8.field2483[var2] & 32767);
				var6.field2456 = 0;
				var6.field2448 = 0;
				var6.field2458 = 0;
				var6.field2459 = -1;
				...
				if (this.field2432[var1] == 0) {
					var6.stream = RawPcmStream.method2673(var9, this.method3788(var6), this.method3789(var6), this.method3790(var6));
				} else {
					var6.stream = RawPcmStream.method2673(var9, this.method3788(var6), 0, this.method3790(var6));
					this.method3775(var6, var8.field2483[var2] < 0);
				}

				if (var8.field2483[var2] < 0) {
