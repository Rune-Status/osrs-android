...
public class Archive extends AbstractArchive {
	...
	int groupLoadPercent(int var1) {
		if (super.groups[var1] != null) {
			...
			int var5;
			if (GrandExchangeEvent.NetCache_currentResponse != null && GrandExchangeEvent.NetCache_currentResponse.key == var3) {
				var5 = VertexNormal.NetCache_responseArchiveBuffer.offset * 99 / (VertexNormal.NetCache_responseArchiveBuffer.array.length - GrandExchangeEvent.NetCache_currentResponse.padding) + 1;
			} else {
				var5 = 0;
			}
	...
	public int percentage() {
		if (this.field3159) {
			...
			int var4;
			if (GrandExchangeEvent.NetCache_currentResponse != null && var2 == GrandExchangeEvent.NetCache_currentResponse.key) {
				var4 = VertexNormal.NetCache_responseArchiveBuffer.offset * 99 / (VertexNormal.NetCache_responseArchiveBuffer.array.length - GrandExchangeEvent.NetCache_currentResponse.padding) + 1;
			} else {
				var4 = 0;
			}
		...
		if (var3) {
			...
			if (var4) {
				...
				if (var2 == null) {
					...
					DirectByteArrayCopier var7 = new DirectByteArrayCopier();
					var7.set(var2);
					var6 = var7;
				} else {
					var6 = var2;
	...
	void load(ArchiveDisk var1, int var2, byte[] var3, boolean var4) {
		...
		if (var1 == this.masterDisk) {
			...
			Buffer var10 = new Buffer(class2.decompressBytes(var3));
			int var11 = var10.readUnsignedByte();
			if (var11 != 5 && var11 != 6) {
				throw new RuntimeException(var11 + "," + this.index + "," + var2);
			}
			...
			if (var4) {
				...
				if (var3 == null) {
					...
					DirectByteArrayCopier var9 = new DirectByteArrayCopier();
					var9.set(var3);
					var8 = var9;
				} else {
					var8 = var3;
