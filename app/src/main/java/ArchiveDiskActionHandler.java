				...
				if (var5 != 10 && var5 != 11) {
					...
					if (var5 >= 12) {
						...
						if (var5 >= 12 && var5 <= 17 && var5 != 13 && var0 > 0) {
							var31 = UrlRequest.field1940[var0][var1];
							var31[var2] |= 2340;
						}
						...
						if (var4 == 0) {
							...
							if (var8.modelClipped) {
								var31 = UrlRequest.field1940[var0][var1 + 1];
								var31[var2] |= 585;
							}
						} else if (var4 == 3) {
							if (var8.clipped) {
						...
						Object var27;
						if (var8.animationId == -1 && var8.transforms == null) {
							var26 = var8.getEntity(2, var4 + 4, var15, var17, var16, var18);
							var27 = var8.getEntity(2, var25, var15, var17, var16, var18);
						} else {
						...
						var6.newBoundaryObject(var0, var1, var2, var16, (Entity)var26, (Entity)var27, Tiles.field508[var4], Tiles.field508[var25], var19, var21);
						if (var8.modelClipped) {
							if (var4 == 0) {
								var31 = UrlRequest.field1940[var0][var1];
								var31[var2] |= 585;
						...
						if (var5 == 5) {
							...
							if (var32 != 0L) {
								var25 = Occluder.getObjectDefinition(GrandExchangeEvents.Entity_unpackID(var32)).int2;
							}
							...
							var6.newWallDecoration(var0, var1, var2, var16, (Entity)var28, (Entity)null, Tiles.field508[var4], 0, var25 * Tiles.field506[var4], var25 * Tiles.field516[var4], var19, var21);
						} else if (var5 == 6) {
							var25 = 8;
							var32 = var6.getBoundaryObjectTag(var0, var1, var2);
							if (0L != var32) {
								var25 = Occluder.getObjectDefinition(GrandExchangeEvents.Entity_unpackID(var32)).int2 / 2;
							}
							...
							var6.newWallDecoration(var0, var1, var2, var16, (Entity)var28, (Entity)null, 256, var4, var25 * Tiles.field503[var4], var25 * Tiles.field517[var4], var19, var21);
						} else if (var5 == 7) {
							var23 = var4 + 2 & 3;
							if (var8.animationId == -1 && var8.transforms == null) {
							...
							var6.newWallDecoration(var0, var1, var2, var16, (Entity)var28, (Entity)var30, 256, var4, var25 * Tiles.field503[var4], var25 * Tiles.field517[var4], var19, var21);
						}
					}
				} else {
					if (var8.animationId == -1 && var8.transforms == null) {
