		...
		if (var2 == 1) {
			...
			if (var2 == 7) {
				...
				if (var2 == 14) {
					...
					Widget var13;
					if (var2 == 24) {
						var13 = Varps.getWidget(var1);
						boolean var14 = true;
						if (var13.contentType > 0) {
							var14 = BufferedSink.method5915(var13);
						}
						...
						if (var2 == 25) {
							var13 = SpriteMask.getWidgetChild(var1, var0);
							if (var13 != null) {
								WorldMapManager.Widget_runOnTargetLeave();
								MusicPatchNode.selectSpell(var1, var0, class83.method2108(WorldMapIcon_0.getWidgetClickMask(var13)), var13.itemId);
								Client.isItemSelected = 0;
								Client.selectedSpellActionName = PcmPlayer.method2542(var13);
								if (Client.selectedSpellActionName == null) {
									Client.selectedSpellActionName = "null";
								}

								if (var13.isIf3) {
									Client.selectedSpellName = var13.dataText + PacketWriter.colorStartTag(16777215);
								} else {
									Client.selectedSpellName = PacketWriter.colorStartTag(65280) + var13.spellName + PacketWriter.colorStartTag(16777215);
								}
							}
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								if (var2 == 38) {
									...
									NPCDefinition.invalidateWidget(var13);
								...
								if (var2 == 39) {
									...
									label415: {
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var13 != null) {
													...
													var9.packetBuffer.writeShortLE(var13.itemId);
													var9.packetBuffer.method5623(FontName.selectedSpellWidget);
													var9.packetBuffer.writeShort(Client.selectedSpellChildIndex);
													Client.packetWriter.addNode(var9);
												}
											...
											if (var2 == 1003) {
												...
												if (var10 != null) {
													...
													if (var16 != null) {
														...
														var12.packetBuffer.writeIntME(var16.id);
														Client.packetWriter.addNode(var12);
													}
												}
												break label415;
											...
											if (var2 == 1005) {
												...
												if (var13 != null && var13.itemQuantities[var0] >= 100000) {
													ClientPreferences.addGameMessage(27, "", var13.itemQuantities[var0] + " x " + HealthBarDefinition.ItemDefinition_get(var3).name);
												} else {
										...
										var13 = SpriteMask.getWidgetChild(var1, var0);
										if (var13 != null) {
											NPC.widgetDefaultMenuAction(var3, var1, var0, var13.itemId, var5);
										}
									}
								}
							}
