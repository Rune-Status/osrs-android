...
public class WorldMapRegion {
	...
	void drawTile(int var1, class40 var2, IndexedSprite[] var3, AbstractArchive var4, AbstractArchive var5) {
		...
		if ((this.worldMapData_0 != null || !this.worldMapData1List.isEmpty()) && class60.method1187(this.regionX, this.regionY, var1) == null) {
			boolean var6 = true;
			...
			if (var6) {
				...
				WorldMapSprite var9 = PlayerType.method4204(var8);
		...
		for (int var5 = 0; var5 < var3.planes; ++var5) {
			...
			if (var6 != null && var6.length != 0) {
				...
				for (int var8 = 0; var8 < var7.length; ++var8) {
					...
					boolean var11 = var10 >= WorldMapDecorationType.field2747.id && var10 <= WorldMapDecorationType.field2748.id;
					if (!var11) {
						int var12 = var9.decoration;
						boolean var13 = var12 == WorldMapDecorationType.field2751.id;
						if (!var13) {
							continue;
						}
					}
	...
	void method460(AbstractWorldMapIcon var1, WorldMapElement var2, int var3, int var4, float var5) {
		...
		if (var6 != null && var6.size.method192(var5)) {
	...
	WorldMapLabel createMapLabel(WorldMapElement var1) {
		if (var1.name != null && this.fonts != null && this.fonts.get(WorldMapLabelSize.WorldMapLabelSize_small) != null) {
			int var2 = var1.textSize;
			WorldMapLabelSize[] var3 = new WorldMapLabelSize[]{WorldMapLabelSize.WorldMapLabelSize_medium, WorldMapLabelSize.WorldMapLabelSize_small, WorldMapLabelSize.WorldMapLabelSize_large};
			WorldMapLabelSize[] var4 = var3;
			int var5 = 0;
			...
			while (true) {
				...
				WorldMapLabelSize var7 = var4[var5];
				if (var2 == var7.field132) {
					var6 = var7;
					break;
				}
			...
			if (var6 == null) {
				...
				Font var15 = (Font)this.fonts.get(var6);
				if (var15 == null) {
					return null;
				} else {
					var5 = var15.lineCount(var1.name, 1000000);
					String[] var8 = new String[var5];
					var15.breakLines(var1.name, (int[])null, var8);
					int var9 = var8.length * var15.ascent / 2;
					int var10 = 0;
					String[] var11 = var8;

					for (int var12 = 0; var12 < var11.length; ++var12) {
						String var13 = var11[var12];
						int var14 = var15.stringWidth(var13);
						if (var14 > var10) {
							var10 = var14;
						}
					}

					return new WorldMapLabel(var1.name, var10, var9, var6);
				}
			}
		} else {
			return null;
				...
				while (true) {
					...
					if (var8 >= 104) {
						for (var8 = 0; var8 < Client.npcCount; ++var8) {
							...
							if (var17 != null && var17.isVisible()) {
								...
								if (var14 != null && var14.drawMapDot && var14.isInteractable) {
									var11 = var17.x / 32 - class192.localPlayer.x / 32;
									var12 = var17.y / 32 - class192.localPlayer.y / 32;
						...
						for (var10 = 0; var10 < var8; ++var10) {
							...
							if (var19 != null && var19.isVisible() && !var19.isHidden && var19 != class192.localPlayer) {
								var12 = var19.x / 32 - class192.localPlayer.x / 32;
								int var15 = var19.y / 32 - class192.localPlayer.y / 32;
								boolean var16 = false;
								if (class192.localPlayer.team != 0 && var19.team != 0 && var19.team == class192.localPlayer.team) {
									var16 = true;
								}

								if (var19.isFriend()) {
									Script.drawSpriteOnMinimap(var1, var2, var12, var15, AbstractWorldMapData.mapDotSprites[3], var4);
								} else if (var16) {
									Script.drawSpriteOnMinimap(var1, var2, var12, var15, AbstractWorldMapData.mapDotSprites[4], var4);
								} else if (var19.isClanMember()) {
									Script.drawSpriteOnMinimap(var1, var2, var12, var15, AbstractWorldMapData.mapDotSprites[5], var4);
								} else {
									Script.drawSpriteOnMinimap(var1, var2, var12, var15, AbstractWorldMapData.mapDotSprites[2], var4);
								}
							}
						}
						...
						if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
							...
							if (Client.hintArrowType == 10 && Client.hintArrowPlayerIndex >= 0 && Client.hintArrowPlayerIndex < Client.players.length) {
								...
								if (var19 != null) {
									var11 = var19.x / 32 - class192.localPlayer.x / 32;
									var12 = var19.y / 32 - class192.localPlayer.y / 32;
									KeyHandler.worldToMinimap(var1, var2, var11, var12, StructDefinition.mapMarkerSprites[1], var4);
								}
							}
						}
					...
					for (var9 = 0; var9 < 104; ++var9) {
						NodeDeque var13 = Client.groundItems[Clock.Client_plane][var8][var9];
						if (var13 != null) {
