	...
	static final void method5213(int var0, int var1) {
		if ((Client.menuOptionsCount >= 2 || Client.isItemSelected != 0 || Client.isSpellSelected) && Client.showMouseOverText) {
			...
			if (Client.isItemSelected == 1 && Client.menuOptionsCount < 2) {
				...
				var3 = VerticalAlignment.method4426(var2);
			}

			if (Client.menuOptionsCount > 2) {
				var3 = var3 + PacketWriter.colorStartTag(16777215) + " " + '/' + " " + (Client.menuOptionsCount - 2) + " more options";
			}

			class1.fontBold12.drawRandomAlphaAndSpacing(var3, var0 + 4, var1 + 15, 16777215, 0, Client.cycle / 1000);
		}
