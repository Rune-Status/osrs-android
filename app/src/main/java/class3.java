...
public class class3 implements Enumerated {
	...
	public static void method52() {
		try {
			...
			if (var0.exists()) {
				...
				label34:
				for (int var2 = 0; var2 < class42.field373.length; ++var2) {
					for (var1 = 0; var1 < ChatChannel.field1291.length; ++var1) {
						File var3 = new File(ChatChannel.field1291[var1] + class42.field373[var2] + File.separatorChar + "random.dat");
						if (var3.exists()) {
	...
	static final int method49(int var0, int var1, int var2) {
		...
		int var13 = 65536 - Rasterizer3D.Rasterizer3D_cosine[var4 * 1024 / var2] >> 1;
