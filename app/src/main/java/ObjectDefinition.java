	...
	final ModelData getModelData(int var1, int var2) {
		...
		if (this.models == null) {
			...
			for (var7 = 0; var7 < var5; ++var7) {
				...
				if (var3 == null) {
					var3 = ModelData.ModelData_get(ObjectDefinition_modelsArchive, var6 & 65535, 0);
					if (var3 == null) {
						return null;
					}
		...
		ModelData var9 = new ModelData(var3, var2 == 0 && !var4 && !var10, this.recolorFrom == null, this.retextureFrom == null, true);
		if (var1 == 4 && var2 > 3) {
			var9.method2850(256);
