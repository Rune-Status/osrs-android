			...
			if (var0 == ScriptOpcodes.WORLDLIST_START) {
				...
				if (var0 == ScriptOpcodes.WORLDLIST_SPECIFIC) {
					...
					for (var5 = 0; var5 < World.World_count; ++var5) {
						if (var6 == class96.World_worlds[var5].id) {
					...
					var6 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize];
					boolean var9 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize + 1] == 1;
					var5 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize + 2];
					boolean var10 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize + 3] == 1;
					WorldMapDecoration.sortWorldList(var6, var9, var5, var10);
					return 1;
					...
					if (var0 == ScriptOpcodes.SETFOLLOWEROPSLOWPRIORITY) {
						...
						if (var0 == ScriptOpcodes.NC_PARAM) {
							...
							var8 = PacketBufferNode.getParamDefinition(var7);
							if (var8.isString()) {
								Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = NetCache.getNpcDefinition(var6).getStringParam(var7, var8.defaultStr);
							} else {
								Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = NetCache.getNpcDefinition(var6).getIntParam(var7, var8.defaultInt);
							}
							...
							var8 = PacketBufferNode.getParamDefinition(var7);
							if (var8.isString()) {
								Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = Occluder.getObjectDefinition(var6).getStringParam(var7, var8.defaultStr);
							} else {
								Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = Occluder.getObjectDefinition(var6).getIntParam(var7, var8.defaultInt);
							}
							...
							var8 = PacketBufferNode.getParamDefinition(var7);
							if (var8.isString()) {
								Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = HealthBarDefinition.ItemDefinition_get(var6).getStringParam(var7, var8.defaultStr);
							} else {
								Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = HealthBarDefinition.ItemDefinition_get(var6).getIntParam(var7, var8.defaultInt);
							}
							...
							var8 = PacketBufferNode.getParamDefinition(var7);
							if (var8.isString()) {
								Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = Fonts.StructDefinition_getStructDefinition(var6).getStringParam(var7, var8.defaultStr);
							} else {
								Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = Fonts.StructDefinition_getStructDefinition(var6).getIntParam(var7, var8.defaultInt);
							}
					...
					var6 = Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize];
					if (var6 >= 0 && var6 < World.World_count) {
						var4 = class96.World_worlds[var6];
						Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var4.id;
						Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var4.properties;
						Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var4.activity;
						Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var4.location;
