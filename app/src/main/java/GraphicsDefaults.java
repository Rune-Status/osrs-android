	...
	static int method5955(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.APPEND_NUM) {
			...
			if (var0 == ScriptOpcodes.APPEND) {
				...
				var3 = Interpreter.Interpreter_stringStack[Message.Interpreter_stringStackSize];
				var5 = Interpreter.Interpreter_stringStack[Message.Interpreter_stringStackSize + 1];
				Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var3 + var5;
				return 1;
				...
				if (var0 == ScriptOpcodes.FROMDATE) {
					...
					Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var6 + "-" + Interpreter.Interpreter_MONTHS[var15] + "-" + var16;
					return 1;
				} else if (var0 != ScriptOpcodes.TEXT_GENDER) {
					if (var0 == ScriptOpcodes.TOSTRING) {
						var7 = Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize];
						Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = Integer.toString(var7);
						return 1;
						...
						if (var0 == ScriptOpcodes.PARAHEIGHT) {
							...
							var9 = MouseHandler.archive13.takeFile(var8, 0);
							var10 = new Font(var9);
							Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var10.lineCount(var3, var4);
							return 1;
							...
							var9 = MouseHandler.archive13.takeFile(var8, 0);
							var10 = new Font(var9);
							Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var10.lineWidth(var3, var4);
							return 1;
							...
							if (Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize] == 1) {
								...
								Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var5;
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize];
							Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = Skills.isCharPrintable((char)var7) ? 1 : 0;
							return 1;
						} else if (var0 == ScriptOpcodes.CHAR_ISALPHANUMERIC) {
							var7 = Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize];
							Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = ArchiveDiskAction.isAlphaNumeric((char)var7) ? 1 : 0;
							return 1;
						} else if (var0 == ScriptOpcodes.CHAR_ISALPHA) {
							var7 = Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize];
							Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = ClanChat.isCharAlphabetic((char)var7) ? 1 : 0;
							return 1;
						} else if (var0 == ScriptOpcodes.CHAR_ISNUMERIC) {
							var7 = Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize];
							Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = class14.isDigit((char)var7) ? 1 : 0;
							return 1;
							...
							var4 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize];
							var8 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize + 1];
							Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var3.substring(var4, var8);
							return 1;
							...
							Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var11.toString();
							return 1;
							...
							Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var3.indexOf(var5, var8);
							return 1;
