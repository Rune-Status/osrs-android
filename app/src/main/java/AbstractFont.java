			...
			for (var14 = 0; var14 < 256; ++var14) {
				if (var14 != 32 && var14 != 160) {
					for (var7 = 0; var7 < 256; ++var7) {
						if (var7 != 32 && var7 != 160) {
							this.kerning[var7 + (var14 << 8)] = (byte)method5414(var6, var13, var4, this.advances, var12, var14, var7);
						}
					}
				}
			}
						...
						if (var9.equals("lt")) {
							...
							if (!var9.equals("gt")) {
								if (var9.startsWith("img=")) {
									try {
										var8 = VerticalAlignment.parseInt(var9.substring(4));
							...
							if (!var14.equals("gt")) {
								if (var14.startsWith("img=")) {
									try {
										...
										++var8;
										var13 = VerticalAlignment.parseInt(var14.substring(4));
