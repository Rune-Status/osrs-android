...
public class JagexCache {
	...
	static int method3566(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.CC_SETOP) {
			...
			if (var5 >= 0 && var5 <= 9) {
				var4.setAction(var5, Interpreter.Interpreter_stringStack[--Message.Interpreter_stringStackSize]);
				return 1;
			} else {
			...
			if (var0 == ScriptOpcodes.CC_SETDRAGGABLE) {
				...
				var4.parent = SpriteMask.getWidgetChild(var5, var6);
				return 1;
				...
				if (var0 != ScriptOpcodes.CC_SETOPKEY) {
					...
					if (var0 == ScriptOpcodes.CC_SETOPTKEY) {
						...
						ClanChat.Widget_setKey(var4, var11, var8, var10);
						return 1;
					...
					if (var3) {
						...
						if (var7 > 0) {
							...
							for (var7 -= 2; var7 >= 0; var7 -= 2) {
								var9[var7 / 2] = (byte)Interpreter.Interpreter_intStack[var7 + class320.Interpreter_intStackSize];
					...
					if (var7 >= 0 && var7 <= 9) {
						ClanChat.Widget_setKey(var4, var7, var9, var8);
						return 1;
					} else {
						throw new RuntimeException();
					}
