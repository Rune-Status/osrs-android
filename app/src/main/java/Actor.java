...
public abstract class Actor extends Entity {
	...
	final void addHitSplat(int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		int var11 = 0;
		if (var1 >= 0) {
			HitSplatDefinition var12 = (HitSplatDefinition)HitSplatDefinition.HitSplatDefinition_cached.get((long)var1);
			HitSplatDefinition var13;
			if (var12 != null) {
				var13 = var12;
			} else {
				byte[] var14 = class49.HitSplatDefinition_archive.takeFile(32, var1);
				var12 = new HitSplatDefinition();
				if (var14 != null) {
					var12.decode(new Buffer(var14));
				}

				HitSplatDefinition.HitSplatDefinition_cached.put(var12, (long)var1);
				var13 = var12;
			}

			var10 = var13.field3337;
