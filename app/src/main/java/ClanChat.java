...
public class ClanChat extends UserList {
	...
	final void readName(String var1) {
		String var2 = WorldMapArea.base37DecodeLong(VerticalAlignment.method4424(var1));
		if (var2 == null) {
			var2 = "";
		}
	...
	public final void readUpdate(Buffer var1) {
		...
		if (var2 > 0L && var2 < 6582952005840035281L) {
			if (0L == var2 % 37L) {
				...
				while (0L != var4) {
					long var9 = var4;
					var4 /= 37L;
					var11.append(class289.base37Table[(int)(var9 - var4 * 37L)]);
				}
		...
		if (var7 != 255) {
			...
			for (int var12 = 0; var12 < var7; ++var12) {
				...
				var13.set(var10, ++this.field3628 - 1);
