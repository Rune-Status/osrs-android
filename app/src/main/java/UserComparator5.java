		...
		if (var0 == ScriptOpcodes.MES) {
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				if (class248.isNumber(var3)) {
					var4 = VerticalAlignment.parseInt(var3);
				}

				var5 = TilePaint.getPacketBufferNode(ClientPacket.field2251, Client.packetWriter.isaacCipher);
				var5.packetBuffer.writeInt(var4);
				Client.packetWriter.addNode(var5);
				return 1;
			} else if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
				var3 = Interpreter.Interpreter_stringStack[--Message.Interpreter_stringStackSize];
				var5 = TilePaint.getPacketBufferNode(ClientPacket.field2280, Client.packetWriter.isaacCipher);
				...
				var3 = Interpreter.Interpreter_stringStack[--Message.Interpreter_stringStackSize];
				var5 = TilePaint.getPacketBufferNode(ClientPacket.field2203, Client.packetWriter.isaacCipher);
				var5.packetBuffer.writeByte(var3.length() + 1);
				var5.packetBuffer.writeStringCp1252NullTerminated(var3);
				Client.packetWriter.addNode(var5);
				return 1;
				...
				if (var0 == ScriptOpcodes.OPPLAYER) {
					...
					var6 = Interpreter.Interpreter_stringStack[--Message.Interpreter_stringStackSize];
					ScriptEvent.method1203(var7, var6);
					return 1;
				} else if (var0 == ScriptOpcodes.IF_DRAGPICKUP) {
					class320.Interpreter_intStackSize -= 3;
					var7 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize];
					var4 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize + 1];
					int var13 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize + 2];
					Widget var11 = Varps.getWidget(var13);
					Strings.clickWidget(var11, var7, var4);
					return 1;
				} else if (var0 == ScriptOpcodes.CC_DRAGPICKUP) {
					class320.Interpreter_intStackSize -= 2;
					var7 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize];
					var4 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize + 1];
					Widget var12 = var2 ? class186.field2331 : MidiPcmStream.field2444;
					Strings.clickWidget(var12, var7, var4);
					return 1;
					...
					if (var0 == ScriptOpcodes.OPENURL) {
						...
						class215.openURL(var3, var8, false);
						return 1;
					} else if (var0 == ScriptOpcodes.RESUME_OBJDIALOG) {
						var7 = Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize];
						var5 = TilePaint.getPacketBufferNode(ClientPacket.field2277, Client.packetWriter.isaacCipher);
						...
						var6 = Interpreter.Interpreter_stringStack[Message.Interpreter_stringStackSize];
						String var10 = Interpreter.Interpreter_stringStack[Message.Interpreter_stringStackSize + 1];
						if (var6.length() > 500) {
							return 1;
						} else if (var10.length() > 500) {
							return 1;
						} else {
							PacketBufferNode var9 = TilePaint.getPacketBufferNode(ClientPacket.field2233, Client.packetWriter.isaacCipher);
							var9.packetBuffer.writeShort(1 + Buddy.stringCp1252NullTerminatedByteSize(var6) + Buddy.stringCp1252NullTerminatedByteSize(var10));
							var9.packetBuffer.writeStringCp1252NullTerminated(var6);
							var9.packetBuffer.method5602(var7);
