...
public class class267 {
	...
	public static synchronized void ByteArrayPool_release(byte[] var0) {
		...
		} else if (ByteArrayPool.ByteArrayPool_arrays != null) {
	...
	static final void checkIfMinimapClicked(Widget var0, int var1, int var2) {
		if ((Client.minimapState == 0 || Client.minimapState == 3) && !Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !ArchiveLoader.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) {
