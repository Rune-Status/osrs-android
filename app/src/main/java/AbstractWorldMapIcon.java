...
public abstract class AbstractWorldMapIcon {
	...
	static final void method613(PacketBuffer var0, int var1, Player var2, int var3) {
		...
		if ((var3 & 64) != 0) {
			...
			if (var5 > 0) {
				for (var6 = 0; var6 < var5; ++var6) {
					...
					var2.addHitSplat(var10, var8, var7, var11, Client.cycle, var12);
				}
			}
			...
			if (var6 > 0) {
				for (var10 = 0; var10 < var6; ++var10) {
					...
					if (var8 != 32767) {
						var11 = var0.readUShortSmart();
						var12 = var0.method5771();
						var9 = var8 > 0 ? var0.method5771() : var12;
						var2.addHealthBar(var7, Client.cycle, var8, var11, var12, var9);
					} else {
						var2.removeHealthBar(var7);
					}
				}
			}
		}
		...
		if ((var3 & 32) != 0) {
			...
			PlayerType var14 = (PlayerType)WorldMapSection0.findEnumerated(SecureRandomFuture.PlayerType_values(), var0.method5771());
			boolean var15 = var0.readUnsignedByte() == 1;
			var7 = var0.method5605();
			var8 = var0.offset;
			if (var2.username != null && var2.appearance != null) {
				boolean var17 = false;
				if (var14.isUser && KeyHandler.friendSystem.isIgnored(var2.username)) {
					var17 = true;
				}

				if (!var17 && Client.field759 == 0 && !var2.isHidden) {
					Players.field1248.offset = 0;
					var0.readBytes(Players.field1248.array, 0, var7);
					Players.field1248.offset = 0;
					String var13 = AbstractFont.escapeBrackets(class40.method735(WallDecoration.method3356(Players.field1248)));
					var2.overheadText = var13.trim();
					var2.overheadTextColor = var5 >> 8;
					var2.overheadTextEffect = var5 & 255;
					var2.overheadTextCyclesRemaining = 150;
					var2.isAutoChatting = var15;
					var2.field954 = var2 != class192.localPlayer && var14.isUser && "" != Client.field780 && var13.toLowerCase().indexOf(Client.field780) == -1;
					...
					if (var14.modIcon != -1) {
						ClientPreferences.addGameMessage(var9, Language.method3728(var14.modIcon) + var2.username.getName(), var13);
					} else {
						ClientPreferences.addGameMessage(var9, var2.username.getName(), var13);
					}
				}
			}

			var0.offset = var7 + var8;
		}
		...
		if ((var3 & 8) != 0) {
			...
			Buffer var18 = new Buffer(var16);
			var0.readBytes(var16, 0, var5);
			Players.field1235[var1] = var18;
			var2.read(var18);
		}
		...
		if (var2.field621) {
			if (var4 == 127) {
				...
				if (var4 != -1) {
					...
					var19 = Players.field1237[var1];
				}

				var2.method1266(var2.tileX, var2.tileY, var19);
			}
		}
