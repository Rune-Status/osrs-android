	...
	static synchronized byte[] ByteArrayPool_getArrayBool(int var0, boolean var1) {
		...
		if (ByteArrayPool_arrays != null) {
			for (int var3 = 0; var3 < ByteArrayPool_alternativeSizes.length; ++var3) {
				...
				} else if (VerticalAlignment.ByteArrayPool_altSizeArrayCounts[var3] > 0) {
					byte[] var4 = ByteArrayPool_arrays[var3][--VerticalAlignment.ByteArrayPool_altSizeArrayCounts[var3]];
					ByteArrayPool_arrays[var3][VerticalAlignment.ByteArrayPool_altSizeArrayCounts[var3]] = null;
					return var4;
				}
			}
		}
