			...
			if (var12 == -1) {
				if (var18 != 0) {
					if (var18 == 1) {
						...
						var8.faceColors1[var17] = method2911(this.faceColors[var17] & '\uffff', var14);
					...
					if (this.field1561 != null && this.field1561[this.indices1[var17]] != null) {
						var13 = this.field1561[this.indices1[var17]];
					} else {
						var13 = this.vertexNormals[this.indices1[var17]];
					}

					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
					var8.faceColors1[var17] = method2911(var16, var14);
					if (this.field1561 != null && this.field1561[this.indices2[var17]] != null) {
						var13 = this.field1561[this.indices2[var17]];
					} else {
						var13 = this.vertexNormals[this.indices2[var17]];
					}

					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
					var8.faceColors2[var17] = method2911(var16, var14);
					if (this.field1561 != null && this.field1561[this.indices3[var17]] != null) {
						var13 = this.field1561[this.indices3[var17]];
					} else {
						var13 = this.vertexNormals[this.indices3[var17]];
					}

					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
					var8.faceColors3[var17] = method2911(var16, var14);
				}
			} else if (var18 != 0) {
				if (var18 == 1) {
					var15 = this.faceNormals[var17];
					var14 = (var4 * var15.y + var5 * var15.z + var3 * var15.x) / (var7 / 2 + var7) + var1;
					var8.faceColors1[var17] = method2861(var14);
					var8.faceColors3[var17] = -1;
				} else {
					var8.faceColors3[var17] = -2;
				}
				...
				var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
				var8.faceColors2[var17] = method2861(var14);
				if (this.field1561 != null && this.field1561[this.indices3[var17]] != null) {
					var13 = this.field1561[this.indices3[var17]];
				} else {
					var13 = this.vertexNormals[this.indices3[var17]];
				...
				var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
				var8.faceColors3[var17] = method2861(var14);
			}
		}
