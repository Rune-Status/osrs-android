		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState != 5) {
				...
				if (Client.gameState == 10 || Client.gameState == 11) {
					...
					int var18 = MouseHandler.MouseHandler_lastPressedX;
					int var19 = MouseHandler.MouseHandler_lastPressedY;
					if (var3 == 0) {
					...
					if (Login.loginIndex == 0) {
						...
						var7 = class96.loginBoxCenter - 80;
						var20 = 291;
						if (var3 == 1 && var18 >= var7 - 75 && var18 <= var7 + 75 && var19 >= var20 - 20 && var19 <= var20 + 20) {
							class215.openURL(class42.method809("secure", true) + "m=account-creation/g=oldscape/create_account_funnel.ws", true, false);
						}

						var7 = class96.loginBoxCenter + 80;
						if (var3 == 1 && var18 >= var7 - 75 && var18 <= var7 + 75 && var19 >= var20 - 20 && var19 <= var20 + 20 || var8) {
						...
						if (Login.loginIndex != 1) {
							...
							if (Login.loginIndex == 2) {
								var10 = 201;
								var9 = var10 + 52;
								if (var3 == 1 && var19 >= var9 - 12 && var19 < var9 + 2) {
								...
								if (Login.field1175 != null) {
									var7 = Login.field1175.highX / 2;
									if (var3 == 1 && var18 >= Login.field1175.lowX - var7 && var18 <= var7 + Login.field1175.lowX && var19 >= var10 - 15 && var19 < var10) {
								...
								var20 = 277;
								Login.field1183 = var18 >= var7 && var18 < var7 + class216.field2559 && var19 >= var20 && var19 < var20 + AbstractWorldMapData.field190;
								...
								var20 = 277;
								Login.field1184 = var18 >= var7 && var18 < var7 + class216.field2559 && var19 >= var20 && var19 < var20 + AbstractWorldMapData.field190;
								...
								while (true) {
									...
									do {
										while (true) {
											...
											if ((KeyHandler.KeyHandler_pressedKeys[82] || KeyHandler.KeyHandler_pressedKeys[87]) && RouteStrategy.field2102 == 67) {
												...
												var22 = var23.getContents(Username.client);
												var26 = 20 - Login.Login_password.length();
												break;
											}
									...
									try {
										String var25 = (String)var22.getTransferData(DataFlavor.stringFlavor);
										int var14 = Math.min(var26, var25.length());

										for (int var15 = 0; var15 < var14; ++var15) {
											if (!BuddyRankComparator.method3510(var25.charAt(var15)) || !class238.method4414(var25.charAt(var15))) {
												Login.loginIndex = 3;
												return;
											}
										}

										Login.Login_password = Login.Login_password + var25.substring(0, var14);
									} catch (UnsupportedFlavorException var16) {
							...
							if (Login.loginIndex == 3) {
								...
								var21 = 276;
								if (var3 == 1 && var18 >= var9 - 75 && var18 <= var9 + 75 && var19 >= var21 - 20 && var19 <= var21 + 20) {
									ViewportMouse.Login_promptCredentials(false);
								}
								...
								if (Login.loginIndex == 4) {
									...
									if (var3 == 1 && var18 >= Login.loginBoxX + 180 - 9 && var18 <= Login.loginBoxX + 180 + 130 && var19 >= 263 && var19 <= 296) {
										Login.field1185 = !Login.field1185;
									}

									if (var3 == 1 && var18 >= Login.loginBoxX + 180 - 34 && var18 <= Login.loginBoxX + 34 + 180 && var19 >= 351 && var19 <= 363) {
									...
									while (SoundSystem.isKeyDown()) {
										...
										for (var11 = 0; var11 < "1234567890".length(); ++var11) {
											if (class51.field432 == "1234567890".charAt(var11)) {
												var12 = true;
												break;
											}
										}
										...
										if (RouteStrategy.field2102 == 13) {
											...
											if (var12 && LoginScreenAnimation.otp.length() < 6) {
									...
									if (WorldMapCacheName.field315 != null) {
										var11 = WorldMapCacheName.field315.highX / 2;
										if (var3 == 1 && var18 >= WorldMapCacheName.field315.lowX - var11 && var18 <= var11 + WorldMapCacheName.field315.lowX && var19 >= var20 - 15 && var19 < var20) {
									...
									while (SoundSystem.isKeyDown()) {
										...
										for (int var13 = 0; var13 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".length(); ++var13) {
											if (class51.field432 == "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(var13)) {
												var12 = true;
												break;
											}
										}
										...
										if (RouteStrategy.field2102 == 13) {
											...
											if (var12 && Login.Login_username.length() < 320) {
												Login.Login_username = Login.Login_username + class51.field432;
											}
										}
									}
										...
										while (true) {
											do {
												if (!SoundSystem.isKeyDown()) {
													var10 = 321;
													if (var3 == 1 && var19 >= var10 - 20 && var19 <= var10 + 20) {
														ViewportMouse.Login_promptCredentials(true);
													}
									...
									if (Login.loginIndex == 7) {
										...
										case 0:
											var24 = "https://support.runescape.com/hc/en-gb/articles/115002238729-Account-Bans";
											break;
										case 1:
											var24 = "https://support.runescape.com/hc/en-gb/articles/206103939-My-account-is-locked";
											break;
										default:
											ViewportMouse.Login_promptCredentials(false);
										}
										...
										var20 = 276;
										if (var3 == 1 && var18 >= var7 - 75 && var18 <= var7 + 75 && var19 >= var20 - 20 && var19 <= var20 + 20) {
											class215.openURL(var24, true, false);
											Tiles.setLoginResponseString("", "Page has opened in a new window.", "(Please check your popup blocker.)");
											Login.loginIndex = 6;
											return;
										}
