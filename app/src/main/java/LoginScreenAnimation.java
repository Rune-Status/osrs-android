...
public class LoginScreenAnimation {
	...
	final void method1806(int var1) {
		...
		for (int var6 = 0; var6 < var4; ++var6) {
			var5 = this.field1040[var3 + var2] - this.field1035[var2 + this.field1037 & this.field1035.length - 1] * var1 / 6;
			if (var5 < 0) {
				var5 = 0;
			}

			this.field1040[var2++] = var5;
		}
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) {
			...
			for (int var10 = 0; var10 < 128; ++var10) {
				...
				if (var8 < 50 && var10 > var15 && var10 < var5) {
					this.field1040[var9 + var10] = 255;
				} else {
					this.field1040[var10 + var9] = 0;
				}
			}
		}
	...
	static int method1808(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) {
			...
			PacketBufferNode var15 = TilePaint.getPacketBufferNode(ClientPacket.field2283, Client.packetWriter.isaacCipher);
			var15.packetBuffer.writeByte(Client.publicChatMode);
			var15.packetBuffer.writeByte(WorldMapSectionType.privateChatMode.field3787);
			var15.packetBuffer.writeByte(Client.tradeChatMode);
			...
			if (var0 == ScriptOpcodes.CHAT_SENDABUSEREPORT) {
				...
				PacketBufferNode var13 = TilePaint.getPacketBufferNode(ClientPacket.field2271, Client.packetWriter.isaacCipher);
				var13.packetBuffer.writeByte(Buddy.stringCp1252NullTerminatedByteSize(var3) + 2);
				...
				if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) {
					...
					var11 = WorldMapRectangle.Messages_getByChannelAndID(var5, var4);
					if (var11 != null) {
						Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var11.count;
						Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var11.cycle;
						Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var11.sender != null ? var11.sender : "";
						Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var11.prefix != null ? var11.prefix : "";
						Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var11.text != null ? var11.text : "";
						Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var11.isFromFriend() ? 1 : (var11.isFromIgnored() ? 2 : 0);
					} else {
					...
					var5 = Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize];
					var11 = class43.Messages_getMessage(var5);
					if (var11 != null) {
						Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var11.type;
						Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var11.cycle;
						Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var11.sender != null ? var11.sender : "";
						Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var11.prefix != null ? var11.prefix : "";
						Interpreter.Interpreter_stringStack[++Message.Interpreter_stringStackSize - 1] = var11.text != null ? var11.text : "";
					...
					if (var0 == ScriptOpcodes.CHAT_SENDPUBLIC) {
						...
						PacketBufferNode var9 = TilePaint.getPacketBufferNode(ClientPacket.field2263, Client.packetWriter.isaacCipher);
						var9.packetBuffer.writeByte(0);
						int var10 = var9.packetBuffer.offset;
						var9.packetBuffer.writeByte(var4);
						var9.packetBuffer.writeByte(var12);
						var9.packetBuffer.writeByte(var14);
						GrandExchangeOfferTotalQuantityComparator.method104(var9.packetBuffer, var3);
						var9.packetBuffer.writeLengthByte(var9.packetBuffer.offset - var10);
						Client.packetWriter.addNode(var9);
						return 1;
					} else if (var0 == ScriptOpcodes.CHAT_SENDPRIVATE) {
						Message.Interpreter_stringStackSize -= 2;
						var3 = Interpreter.Interpreter_stringStack[Message.Interpreter_stringStackSize];
						var6 = Interpreter.Interpreter_stringStack[Message.Interpreter_stringStackSize + 1];
						PacketBufferNode var7 = TilePaint.getPacketBufferNode(ClientPacket.field2241, Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeShort(0);
						int var8 = var7.packetBuffer.offset;
						var7.packetBuffer.writeStringCp1252NullTerminated(var3);
						GrandExchangeOfferTotalQuantityComparator.method104(var7.packetBuffer, var6);
						...
						if (var0 == ScriptOpcodes.CHAT_GETFILTER_TRADE) {
							...
							var5 = Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize];
							Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = class51.Messages_getHistorySize(var5);
							return 1;
						} else if (var0 == ScriptOpcodes.CHAT_GETNEXTUID) {
							var5 = Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize];
							Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = class13.Messages_getNextChatID(var5);
							return 1;
						} else if (var0 == ScriptOpcodes.CHAT_GETPREVUID) {
							var5 = Interpreter.Interpreter_intStack[--class320.Interpreter_intStackSize];
							Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = ItemDefinition.Messages_getLastChatID(var5);
							return 1;
