				...
				do {
					...
					for (int var14 = this.menuOpcodes.length - 1; var14 >= 0; --var14) {
						if (var13.menuActions[var14] != null) {
							GraphicsObject.insertMenuItemNoShift(var13.menuActions[var14], var13.menuTargetName, this.menuOpcodes[var14], var12.getElement(), var12.coord1.packed(), var12.coord2.packed());
							var11 = true;
						}
					}
				} while(!var11);
