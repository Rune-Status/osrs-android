...
public final class NPC extends Actor {
	...
	protected final Model getModel() {
		if (this.definition == null) {
			...
			SequenceDefinition var2 = super.movementSequence == -1 || super.movementSequence == super.readySequence && var1 != null ? null : GraphicsDefaults.SequenceDefinition_get(super.movementSequence);
	...
	static void widgetDefaultMenuAction(int var0, int var1, int var2, int var3, String var4) {
		...
		if (var5 != null) {
			...
			if (var11) {
				int var7 = WorldMapIcon_0.getWidgetClickMask(var5);
				int var8 = var0 - 1;
