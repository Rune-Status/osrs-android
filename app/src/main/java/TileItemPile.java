...
public final class TileItemPile {
	...
	static int method2834(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.ADD) {
			...
			int var12 = Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize + 4];
			Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = var3 + (var12 - var11) * (var4 - var3) / (var6 - var11);
			return 1;
			...
			long var5 = (long)Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize];
			long var7 = (long)Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize + 1];
			long var9 = (long)Interpreter.Interpreter_intStack[class320.Interpreter_intStackSize + 2];
			Interpreter.Interpreter_intStack[++class320.Interpreter_intStackSize - 1] = (int)(var5 * var9 / var7);
			return 1;
		} else {
			return 2;
		}
