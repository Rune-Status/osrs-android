...
public class Texture extends Node {
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) {
			...
			byte[] var8 = var4.takeFileFlat(var7);
			boolean var9;
			if (var8 == null) {
				var9 = false;
			} else {
				SpriteMask.SpriteBuffer_decode(var8);
				var9 = true;
			}
			...
			if (!var9) {
				...
				var10 = class313.method5962();
			}

			var10.normalize();
			var8 = var10.pixels;
			int[] var11 = var10.palette;
			...
			if (var13 == 0) {
				if (var3 == var10.subWidth) {
					for (var14 = 0; var14 < var5; ++var14) {
						this.pixels[var14] = var11[var8[var14] & 255];
					}
				} else if (var10.subWidth == 64 && var3 == 128) {
					var14 = 0;

					for (var15 = 0; var15 < var3; ++var15) {
						for (var16 = 0; var16 < var3; ++var16) {
							this.pixels[var14++] = var11[var8[(var15 >> 1 << 6) + (var16 >> 1)] & 255];
						}
					}
				} else {
					if (var10.subWidth != 128 || var3 != 64) {
						throw new RuntimeException();
					}
					...
					for (var15 = 0; var15 < var3; ++var15) {
						for (var16 = 0; var16 < var3; ++var16) {
							this.pixels[var14++] = var11[var8[(var16 << 1) + (var15 << 1 << 7)] & 255];
						}
					}
				}
			}
