	...
	public void read(byte[] var1, int var2, int var3) throws IOException {
		try {
			...
			if (-1L != this.writeBufferOffset) {
				...
				} else if ((long)var6 + var4 > this.writeBufferOffset && (long)var6 + var4 <= (long)this.writeBufferLength + this.writeBufferOffset) {
		...
		try {
			...
			if (var3 <= this.writeBuffer.length) {
				...
				if (var10 > -1L && var6 > var10) {
					...
					System.arraycopy(var1, (int)((long)var2 + var10 - this.offset), this.readBuffer, (int)(var10 - this.readBufferOffset), var8);
				}
