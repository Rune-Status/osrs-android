	...
	public void load(AbstractArchive var1, String var2, boolean var3) {
		if (!this.loadStarted) {
			...
			if (var1.isValidFileName(WorldMapCacheName.field310.name, var2)) {
				byte[] var18 = var1.takeFileByNames(WorldMapCacheName.field310.name, var2);
				this.compositeTextureSprite = class14.convertJpgToSprite(var18);
			}
			...
			if (var6 > 0 && var6 % var7 < var7 / 2) {
				...
				while (true) {
					...
					while (var14.hasNext()) {
						...
						int var12 = var3 * (var11.coord2.x - this.tileX * 4096) / (this.tileWidth * 4096);
						int var13 = var4 - (var11.coord2.y - this.tileY * 4096) * var4 / (this.tileHeight * 4096);
