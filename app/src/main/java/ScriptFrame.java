...
public class ScriptFrame {
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.field975 != 0) {
			if (var0.targetIndex != -1) {
				...
				if (var0.targetIndex < 32768) {
					var3 = Client.npcs[var0.targetIndex];
				} else if (var0.targetIndex >= 32768) {
					var3 = Client.players[var0.targetIndex - 32768];
				}

				if (var3 != null) {
					int var4 = var0.x - ((Actor)var3).x;
					int var5 = var0.y - ((Actor)var3).y;
					if (var4 != 0 || var5 != 0) {
			...
			if (var2 != 0) {
				...
				if (var2 > 1024) {
					...
					var7 = true;
					if (var2 < var0.field975 || var2 > 2048 - var0.field975) {
						var0.rotation = var0.orientation;
						var7 = false;
					}

					if (var0.movementSequence == var0.readySequence && (var0.field956 > 25 || var7)) {
		...
		if (var0.movementSequence != -1) {
			var8 = GraphicsDefaults.SequenceDefinition_get(var0.movementSequence);
			if (var8 != null && var8.frameIds != null) {
				...
				if (var0.movementFrame < var8.frameIds.length && var0.movementFrameCycle > var8.frameLengths[var0.movementFrame]) {
					...
					++var0.movementFrame;
					GameObject.addSequenceSoundEffect(var8, var0.movementFrame, var0.x, var0.y);
				}
		...
		if (var0.spotAnimation != -1 && Client.cycle >= var0.field979) {
			...
			var2 = class65.SpotAnimationDefinition_get(var0.spotAnimation).sequence;
			if (var2 != -1) {
				SequenceDefinition var6 = GraphicsDefaults.SequenceDefinition_get(var2);
				if (var6 != null && var6.frameIds != null) {
					...
					if (var0.spotAnimationFrame < var6.frameIds.length && var0.spotAnimationFrameCycle > var6.frameLengths[var0.spotAnimationFrame]) {
						...
						GameObject.addSequenceSoundEffect(var6, var0.spotAnimationFrame, var0.x, var0.y);
					}
		...
		if (var0.sequence != -1 && var0.sequenceDelay <= 1) {
			var8 = GraphicsDefaults.SequenceDefinition_get(var0.sequence);
			if (var8.field3523 == 1 && var0.field998 > 0 && var0.field985 <= Client.cycle && var0.field986 < Client.cycle) {
		...
		if (var0.sequence != -1 && var0.sequenceDelay == 0) {
			...
			if (var8 != null && var8.frameIds != null) {
				...
				if (var0.sequenceFrame < var8.frameIds.length && var0.sequenceFrameCycle > var8.frameLengths[var0.sequenceFrame]) {
					...
					++var0.sequenceFrame;
					GameObject.addSequenceSoundEffect(var8, var0.sequenceFrame, var0.x, var0.y);
				}

				if (var0.sequenceFrame >= var8.frameIds.length) {
					var0.sequenceFrame -= var8.frameCount;
					++var0.field983;
					if (var0.field983 >= var8.field3522) {
						var0.sequence = -1;
