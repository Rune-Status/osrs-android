	...
	static final void updateItemPile(int var0, int var1) {
		...
		if (var2 == null) {
			...
			if (var5 == null) {
				...
				ServerBuild.scene.newGroundItemPile(Clock.Client_plane, var0, var1, WorldMapSectionType.getTileHeight(var0 * 128 + 64, var1 * 128 + 64, Clock.Client_plane), var5, var9, var11, var12);
			}
		}
			...
			if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !VarcInt.isComponentHidden(var3))) {
				...
				if (var3.type == 6) {
					...
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
						boolean var5 = ScriptFrame.runCs1(var3);
						if (var5) {
						...
						if (var7 != -1) {
							SequenceDefinition var6 = GraphicsDefaults.SequenceDefinition_get(var7);
					...
					if (var3.field2696 != 0 && !var3.isIf3) {
						...
						var7 = var3.field2696 << 16 >> 16;
						var8 *= Client.field707;
						var7 *= Client.field707;
